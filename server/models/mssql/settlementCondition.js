...
const SettlementCondition = (sequelize) => {
    const attributes = {
    ...
    return sequelize.define('vSettlementConditions', attributes, { freezeTableName: true, timestamps: false });

}

export default SettlementCondition;