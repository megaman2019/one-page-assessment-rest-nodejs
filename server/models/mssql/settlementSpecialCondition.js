...
const SettlementSpecialCondition = (sequelize) => {
    const attributes = {
    ...
    return sequelize.define('vSettlementSpecialConditions', attributes, { freezeTableName: true, timestamps: false });

}

export default SettlementSpecialCondition;