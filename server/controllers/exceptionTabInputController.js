...
import ExceptionTabInput from '../models/mongodb/exceptionTabInput.js';
...
export const _getOneByAppId = async(req, res) => {
    ...
    await getOneByAppId(appId, ExceptionTabInput)
        .then((output) => {
...
export const _createOrUpdate = async (req, res) => {
    ...
    try {
        const output = await createOrUpdate(data, ExceptionTabInput);
...
export const _remove = async (req, res) => {
    ...
    await remove(appId, ExceptionTabInput)
        .then((output) => {            
