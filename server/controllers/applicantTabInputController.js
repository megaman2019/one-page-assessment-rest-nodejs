...
import ApplicantTabInput from '../models/mongodb/applicantTabInput.js';
...
export const _getOneByAppId = async(req, res) => {
    ...
    await getOneByAppId(appId, ApplicantTabInput)
        .then((output) => {
...
export const _createOrUpdate = async (req, res) => {
    ...
    try {
        const output = await createOrUpdate(data, ApplicantTabInput);
...
export const _remove = async (req, res) => {
    ...
    await remove(appId, ApplicantTabInput)
        .then((output) => {            
