...
import DecisionSummaryTabInput from '../models/mongodb/decisionSummaryTabInput.js';
...
export const _getOneByAppId = async(req, res) => {
    ...
    await getOneByAppId(appId, DecisionSummaryTabInput)
        .then((output) => {
...
export const _createOrUpdate = async (req, res) => {
    ...
    try {
        const output = await createOrUpdate(data, DecisionSummaryTabInput);
...
export const _remove = async (req, res) => {
    ...
    await remove(appId, DecisionSummaryTabInput)
        .then((output) => {            
