...
import AssetAndLiabilityTabInput from '../models/mongodb/assetAndLiabilityTabInput.js';
...
export const _getOneByAppId = async(req, res) => {
    ...
    await getOneByAppId(appId, AssetAndLiabilityTabInput)
        .then((output) => {
...
export const _createOrUpdate = async (req, res) => {
    ...
    try {
        const output = await createOrUpdate(data, AssetAndLiabilityTabInput);
...
export const _remove = async (req, res) => {
    ...
    await remove(appId, AssetAndLiabilityTabInput)
        .then((output) => {            
