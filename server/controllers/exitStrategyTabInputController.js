...
import ExitStrategyTabInput from '../models/mongodb/exitStrategyTabInput.js';
...
export const _getOneByAppId = async(req, res) => {
    ...
    await getOneByAppId(appId, ExitStrategyTabInput)
        .then((output) => {
...
export const _createOrUpdate = async (req, res) => {
    ...
    try {
        const output = await createOrUpdate(data, ExitStrategyTabInput);
...
export const _remove = async (req, res) => {
    ...
    await remove(appId, ExitStrategyTabInput)
        .then((output) => {            
