...
import SecurityTabInput from '../models/mongodb/securityTabInput.js';
...
export const _getOneByAppId = async(req, res) => {
    ...
    await getOneByAppId(appId, SecurityTabInput)
        .then((output) => {
...
export const _createOrUpdate = async (req, res) => {
    ...
    try {
        const output = await createOrUpdate(data, SecurityTabInput);
...
export const _remove = async (req, res) => {
    ...
    await remove(appId, SecurityTabInput)
        .then((output) => {            
