...
import ConditionTabInput from '../models/mongodb/conditionTabInput.js';
...
export const _getOneByAppId = async(req, res) => {
    ...
    await getOneByAppId(appId, ConditionTabInput)
        .then((output) => {
...
export const _createOrUpdate = async (req, res) => {
    ...
    try {
        const output = await createOrUpdate(data, ConditionTabInput);
...
export const _remove = async (req, res) => {
    ...
    await remove(appId, ConditionTabInput)
        .then((output) => {            
