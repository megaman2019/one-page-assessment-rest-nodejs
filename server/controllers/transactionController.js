...
import TransactionTabInput from '../models/mongodb/transactionTabInput.js';
...
export const _getOneByAppId = async(req, res) => {
    ...
    await getOneByAppId(appId, TransactionTabInput)
        .then((output) => {
...
export const _createOrUpdate = async (req, res) => {
    ...
    try {
        const output = await createOrUpdate(data, TransactionTabInput);
...
export const _remove = async (req, res) => {
    ...
    await remove(appId, TransactionTabInput)
        .then((output) => {            
