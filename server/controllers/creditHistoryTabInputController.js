...
import CreditHistoryTabInput from '../models/mongodb/creditHistoryTabInput.js';
...
export const _getOneByAppId = async(req, res) => {
    ...
    await getOneByAppId(appId, CreditHistoryTabInput)
        .then((output) => {
...
export const _createOrUpdate = async (req, res) => {
    ...
    try {
        const output = await createOrUpdate(data, CreditHistoryTabInput);
...
export const _remove = async (req, res) => {
    ...
    await remove(appId, CreditHistoryTabInput)
        .then((output) => {            
