...
import IncomeTabInput from '../models/mongodb/incomeTabInput.js';
...
export const _getOneByAppId = async(req, res) => {
    ...
    await getOneByAppId(appId, IncomeTabInput)
        .then((output) => {
...
export const _createOrUpdate = async (req, res) => {
    ...
    try {
        const output = await createOrUpdate(data, IncomeTabInput);
...
export const _remove = async (req, res) => {
    ...
    await remove(appId, IncomeTabInput)
        .then((output) => {            
