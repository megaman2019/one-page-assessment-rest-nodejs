...
import ResponsibleLendingTabInput from '../models/mongodb/responsibleLendingTabInput.js';
...
export const _getOneByAppId = async(req, res) => {
    ...
    await getOneByAppId(appId, ResponsibleLendingTabInput)
        .then((output) => {
...
export const _createOrUpdate = async (req, res) => {
    ...
    try {
        const output = await createOrUpdate(data, ResponsibleLendingTabInput);
...
export const _remove = async (req, res) => {
    ...
    await remove(appId, ResponsibleLendingTabInput)
        .then((output) => {            
