...
import ServicingTabInput from '../models/mongodb/servicingTabInput.js';
...
export const _getOneByAppId = async(req, res) => {
    ...
    await getOneByAppId(appId, ServicingTabInput)
        .then((output) => {
...
export const _createOrUpdate = async (req, res) => {
    ...
    try {
        const output = await createOrUpdate(data, ServicingTabInput);
...
export const _remove = async (req, res) => {
    ...
    await remove(appId, ServicingTabInput)
        .then((output) => {            
